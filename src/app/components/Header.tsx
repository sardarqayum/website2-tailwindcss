...
const Header =() =>{
    ...
    return(
        <header className="bg-blue-500 text-white py-5 flex justify-between items-center px-10 relative z-10">
            <h1 className="text-2xl font-bold">Brands-Shop</h1>
         ...
         <nav className="hidden md:flex gap-10 text-white font-bold">
            ...
            <Link href="/New-Design" onClick={closeMenu}>New-design</Link>
         ...
         <div className="md:hidden flex items-center">
            <HiMenuAlt3 className="text-white text-3xl cursor-pointer"onClick={toggleMenu}  //toggle menu on click
            />
         </div>
        ...
        <div className="flex justify-end">
            <HiX className="text-white text-3xl cursor-pointer"onClick={toggleMenu}//close when clicked
            /> 
        </div>
